...
public class TCPServerThread50 extends Thread {
    ...
    public TCPServerThread50(Socket client_, TCPServer50 tcpserver_, int clientID_,
            TCPServerThread50[] cli_ami_) {
        this.client = client_;
    ...
    public void run() {
        ...
        try {
            try {
                ...
                tcpserver.sendMessageTCPServer("id " + String.valueOf(this.clientID - 1), clientID);
                ...
                System.out
                        .println("RESPONSE FROM CLIENT" + "S: Received Message: '" + message + "'");
            } catch (Exception e) {
